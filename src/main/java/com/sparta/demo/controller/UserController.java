...
public class UserController {
    ...
    public ResponseEntity<KakaoUserInfoDto> updateUserInfo(@RequestBody UserRequestDto userRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails){
        return userService.updateUserInfo(userRequestDto.getNickName(), userDetails);
    }
