...
public class ChatRoomRepository {
    ...
    // 채팅방의 대화 메시지를 발행하기 위한 redis topic 정보. 서버별로 채팅방에 매치되는 topic 정보를 Map 에 넣어 debateId 로 찾을수 있도록 한다.
    ...
    public ChatRoom createChatRoom(String name) {
        ...
        opsHashChatRoom.put(CHAT_ROOMS, chatRoom.getDebateId(), chatRoom);
        return chatRoom;
    }
